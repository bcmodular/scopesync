...
#define USE_SSE2	//eigentlich nicht nötig. aber die SSE1 version nutzt MMX intrinsics die es auf x64 nicht mehr gib
...
_PS_CONST(cephes_LOG2EF, 1.44269504088896341f); //hier 1 benutzen für 2^x
